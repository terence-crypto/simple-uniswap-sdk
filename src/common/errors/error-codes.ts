export enum ErrorCodes {
  ...
  tokenAContractAddressRequired = 21,
  tokenAContractAddressNotValid = 22,
  tokenBContractAddressRequired = 23,
  tokenBContractAddressNotValid = 24,
  invalidQuoterContext = 25,
}
